...
export default function TeacherLabDetailsPage() {
  ...
  return (
    <div className="space-y-6 relative min-h-[calc(100vh-8rem)]">
                  ...
                  <tr key={sub.id} className="hover:bg-zinc-900/30 transition group">
                    <td className="p-4 font-bold text-white">
                      {sub.teamName ? (
                        <div className="flex flex-col">
                          ...
                          <span className="text-[10px] text-purple-400 font-medium font-bold uppercase">Командная</span>
                        </div>
                      ) : (
                    ...
                    <td className="p-4">
                      <a 
                        ...
                        className="inline-flex items-center gap-1 text-purple-400 hover:text-purple-300 font-medium hover:underline text-xs"
                      >
                    ...
                    <td className="p-4 text-right">
                      <button
                        ...
                        className="px-3 py-1.5 bg-zinc-900 hover:bg-purple-600/10 border border-zinc-800 hover:border-purple-600/30 text-zinc-300 hover:text-purple-400 rounded-lg text-xs font-semibold transition cursor-pointer"
                      >
      ...
      {/* Slide-out Drawer Panel (HTML/CSS simulated drawer overlay) */}
      {selectedSub && (
          ...
          <div className="w-full max-w-md h-full bg-[#09090b] border-l border-zinc-800 p-6 flex flex-col justify-between shadow-2xl relative animate-slide-in">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="p-3 bg-zinc-900/50 border border-zinc-800 rounded-lg flex items-center justify-between text-xs">
                  ...
                  <a href={selectedSub.fileUrl} className="text-purple-400 hover:text-purple-300 font-bold flex items-center gap-1">
              ...
              <form id="grading-form" onSubmit={handleGradeSubmit} className="space-y-5">
                <div className="space-y-2">
                  <label className="flex items-center gap-1.5 text-xs font-semibold text-zinc-400 uppercase tracking-wider">
                    <Award className="h-4 w-4 text-purple-400" /> Выставить оценку (макс. {lab.maxGrade})
                  </label>
                  <select
                    value={gradeInput}
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full p-3 bg-zinc-900 border border-zinc-800 rounded-lg text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500 resize-none"
                  />
                </div>
              </form>
            </div>
            ...
            <div className="border-t border-zinc-900 pt-4 flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-2.5 bg-purple-600 hover:bg-purple-500 text-white rounded-lg font-semibold text-xs transition flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-purple-600/20 disabled:opacity-50"
              >
                {gradingSubmit ? (
                  <>
